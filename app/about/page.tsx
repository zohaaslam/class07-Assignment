...
import  pinkimage from "../public/pink image.jpg"
...
export default function About() {
  ...
  <button className="w-[237px] h-[66px] p-3 ml-5  hover:bg-orange-500 bg-purple-900 text-white ">Contact Us</button></div>
